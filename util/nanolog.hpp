...
enum class LogLevel : uint8_t { DEBUG, INFO, WARN, ERR, CRIT };
...
public:
	struct alignas(64) Item
	{
		Item() 
		: written(0)
		, logline(LogLevel::DEBUG, nullptr, nullptr, 0)
		{
		}
...
public:
	...
	void pop()
	{
		...
		NanoLogLine logline(LogLevel::DEBUG, nullptr, nullptr, 0);
...
#define LOG_DBG nanolog::Logger::is_logged(nanolog::LogLevel::DEBUG) && NANO_LOG(nanolog::LogLevel::DEBUG)
...
#define LOG_ERR nanolog::Logger::is_logged(nanolog::LogLevel::ERR) && NANO_LOG(nanolog::LogLevel::ERR)
